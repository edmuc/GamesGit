...
ALTO = 600
FPS = 60
DURACION_JUEGO = 300  # 5 minutos en segundos (estaba en 60, lo corregí a 300 para que sean 5 min)
VELOCIDAD_BASE = 1.3
...
class Jugador(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        try:
            # USANDO resource_path AQUI
            ruta = resource_path('assets/cat.png')
            cat = pygame.image.load(ruta)
            self.image = pygame.transform.scale(cat, (60, 60))
        except Exception as e:
            print(f"Error cargando imagen jugador: {e}")
...
class Enemigo(pygame.sprite.Sprite):
    def __init__(self, x, y, velocidad):
        ...
        try:
             # USANDO resource_path AQUI
            ruta = resource_path('assets/chuky.png')
            chuky = pygame.image.load(ruta)
...
class Juego:
    def __init__(self):
        ...
        try:
            # USANDO resource_path AQUI
            ruta_musica = resource_path('assets/musica.mp3')
